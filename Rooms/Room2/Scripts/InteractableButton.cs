...
public partial class InteractableButton : StaticBody3D, IInteractable
{
	...
	[Export] private CollisionShape3D _chairCollision2;
	[Export] private CollisionShape3D _floorCollision;

	public void Interact()
	{
		if (_chairCollision != null && _chairCollision2 != null && _floorCollision != null)
		{
			...
			_chairCollision2.SetDeferred(CollisionShape3D.PropertyName.Disabled, true);
